  ...
  return (
    <div className="container py-20">
      ...
      <p>
        ...
        aspernatur facilis illum quisquam dicta similique recusandae nisi ullam
        voluptates perferendis mollitia soluta, quo quae dolor possimus. Sunt
        quis ex eius!
      </p>
      ...
      <ul>
        ...
        <li>
          Suplencia como docente de danzas clásicas y francés en la Academia de
          Ballet de Moscú.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Invitada especial en Gala de Ballet en Formosa, dirigida por el Mtro.
          Alexander Ananiev. Interpretando rol de Hada de Azúcar en Cascanueces
          y solista principal de la obra Markitenka - 2015.
        </li>
        <li>
          Solista en pas de deux La Fille Mal Gardée - Abril y Mayo de 2015.
        </li>
        <li>
          Solista como Moyna en Giselle, Gala junto a Marianela Nuñez - Julio de
          2015.
        </li>
        <li>
        ...
        <li>
          Invitada especial Gala de Ballet en Formosa para la obra Don Quijote,
          actuando en el rol de Kitry de primera bailarina - 2017.
        </li>
        <li>
        ...
        <li>
          Repositora coreográfica e invitada Gala de Ballet en Santo Tomé en el
          rol de Odette del Ballet Lago de los Cisnes, 2022.
        </li>
      </ul>

      <h2>Actividades, cursos y premios obtenidos:</h2>
      <ul>
        <li>Integrante del Ballet Infanto Juvenil de Paraná.</li>
        <li>
          Certamen "Danzamerica" realizado en la cuidad de Villa Carlos Paz -
          Córdoba. Premios: 1º Premio: por el solista "Al Ritmo del 2x4" - danza
          libre. 2º Premio: por el solista "Variación de Nikia" - clásico de
          repertorio.
        </li>
        <li>
          Ganadora del 1° Premio Nacional con variación clásica en Troyes,
          Francia. Ganadora del 3° Premio Nacional en Concours National de Danse
          en Francia.
        </li>
        <li>
          Ganadora del 2° Premio categoría Profesional en Preselección
          Internacional concurso VKIBC e invitación para la final en New York
          del concurso VKIBC.
        </li>
        <li>
      ...
      <h2>Cursos, seminarios y profesores</h2>
      <ul>
        <li>Curso de verano en la Fundación Julio Bocca (2008-2011-2012).</li>
        <li>
          Curso de verano en la Asociación Arte y Cultura, Buenos Aires
          (2009-2010).
        </li>
        <li>
          Cursos y clases con los profesores: Susana Gómez, Katty Gallo, Cecilia
          Kerche, Raúl Candal, Lidia Segni, Claudio Longo, Stella Saladino,
          Sylvia Bazilis, Ricardo Rivas, Daniel Negroni, Miguel Bonin, José Luis
          Lozano, María Elizabeth Sture, Raquel Rosetti, Atilio Labis, Catherine
          Goffinon, Anissa Serai, Vivien Visentin, Floriane Blitz, Adolfo
          Burgos, Laura Fiorucci, David Sturmer, Andrea Carolina Escobar,
          Rodolfo Romero, Mario Silva, Julieta Saravia.
        </li>
      </ul>
